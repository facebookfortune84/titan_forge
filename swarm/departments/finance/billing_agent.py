...
class BillingAgent(BaseAgent):
    def __init__(self, model_name: str = settings.LLM_MODEL_NAME):
        super().__init__(
            ...
            goal="Automate Stripe payment processing, subscription lifecycle management, and ensure accurate financial record-keeping.",
            backstory="Equipped with deep knowledge of Stripe's API and financial regulations, this agent ensures that all transactions are processed securely and correctly, keeping the business financially sound and compliant.",
